...
with open('C:/Users/lenovo/Desktop/Avani Coding/Minor 2 - Semester 6/Digitizer/data/words.txt','r') as f:
    for i in range(50):
        line = f.readline()
        print(line)
...
base_path = "C:/Users/lenovo/Desktop/Avani Coding/Minor 2 - Semester 6/Digitizer/data"
words_list = []
...
with tf.keras.utils.custom_object_scope({'CTCLayer': CTCLayer}):
    new_model = tf.keras.models.load_model('C:/Users/lenovo/Desktop/Avani Coding/Minor 2 - Semester 6/Digitizer/handwriting.h5')
